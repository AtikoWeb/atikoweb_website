							...
							<Dialog.Panel className='relative transform w-screen p-12 overflow-hidden rounded-3xl backdrop-blur-2xl bg-white/[.6] dark:bg-black/70 text-left shadow-2xl transition-all sm:my-8 sm:w-full sm:max-w-lg'>
								...
								<div className='mb-5'>
									...
									<input
										type='name'
										id='name'
										className='shadow-sm bg-black/[.1] border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500 dark:shadow-sm-light'
								...
								<div>
									...
									<input
										type='phone'
										id='phone'
										className='shadow-sm bg-black/[.1] border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500 dark:shadow-sm-light'
