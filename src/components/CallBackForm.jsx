			...
			>
				...
				<div className='fixed inset-0 z-10 overflow-y-auto'>
					<div className='flex min-h-full items-end justify-center text-center sm:items-center'>
						...
						>
							<Dialog.Panel className='relative transform w-screen p-12 overflow-hidden rounded-3xl backdrop-blur-2xl bg-white/[.6] dark:bg-[#1D222A]/[.8] text-left shadow-2xl transition-all sm:my-8 sm:w-full sm:max-w-lg'>
								<div
