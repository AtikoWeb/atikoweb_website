...
function Grocery() {
	const tarifs = [
		{ title: 'Продуктовый.Помесячный', price: 7500, qtyMonths: 'месяц' },
		{ title: 'Продуктовый.Годовой', price: 65000, qtyMonths: '12 месяцев' },
	];

	return (
		<>
			<Hero
				title={'Продуктовая революция'}
				highlightWordIndex={1}
				imageUrl={'/grocery_hero_img.svg'}
